...
.method private static runSelectLoop()V
    ...
    .line 585
    .local v7, "peers":Ljava/util/ArrayList;, "Ljava/util/ArrayList<Lcom/android/internal/os/ZygoteConnection;>;"
    const/4 v8, 0x4

    new-array v3, v8, [Ljava/io/FileDescriptor;

    .line 587
    .local v3, "fdArray":[Ljava/io/FileDescriptor;
    sget-object v8, Lcom/android/internal/os/ZygoteInit;->sServerSocket:Landroid/net/LocalServerSocket;

    invoke-virtual {v8}, Landroid/net/LocalServerSocket;->getFileDescriptor()Ljava/io/FileDescriptor;
    ...
    const-string v9, "Error in select()"
    ...
    .line 604
    .local v6, "newPeer":Lcom/android/internal/os/ZygoteConnection;
    invoke-virtual {v7, v6}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 605
    invoke-virtual {v6}, Lcom/android/internal/os/ZygoteConnection;->getFileDesciptor()Ljava/io/FileDescriptor;
    ...
    .line 608
    .end local v6    # "newPeer":Lcom/android/internal/os/ZygoteConnection;
    :cond_2
    invoke-virtual {v7, v5}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object v8

    check-cast v8, Lcom/android/internal/os/ZygoteConnection;

    invoke-virtual {v8}, Lcom/android/internal/os/ZygoteConnection;->runOnce()Z
...
.method private static startSystemServer()Z
    ...
    const-string v1, "--setgroups=1001,1002,1003,1004,1005,1006,1007,1008,1009,1010,1018,1021,1032,3001,3002,3003,3006,3007,3009"
